...
export default function RefundPage() {
  return (
    <LegalPage title="Refund & Cancellation Policy" lastUpdated="21 May 2026">
      ...
      <h2>1. Premium membership (₹99 / $1.99)</h2>
      <ul>
        <li><strong>Cooling-off period</strong> — full refund within <strong>7 days</strong> of payment, no questions asked</li>
        <li><strong>After 7 days</strong> — non-refundable, because the membership is one-time payment for lifetime access</li>
