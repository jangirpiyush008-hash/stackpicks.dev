...
import { ConnectComingSoon } from '../../components/ConnectComingSoon';
...
export default async function ConnectPage() {
  ...
  // Launch gate: public sees a full "Coming soon" takeover until we hit the
  // live-app target. Admins always get the real directory (to test + wire).
  ...
  if (gated) {
    return (
      <div className="max-w-[1400px] mx-auto px-4 md:px-6">
        ...
        />
        <ConnectComingSoon target={CONNECT_LAUNCH_TARGET} />
      </div>
    );
  }
