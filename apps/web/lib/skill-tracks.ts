...
export const SKILL_TRACKS: SkillTrack[] = [
  ...
  // ───────────────────────────────────────────────────────────────────
  {
    ...
    repos: [
      ...
      { full_name: 'calcom/cal.diy',           subcategory: 'Scheduling',       why: 'Open-source Calendly. Self-host, white-label, embed in your site.' },
  ...
  // ───────────────────────────────────────────────────────────────────
  {
    ...
    repos: [
      ...
      { full_name: 'Comfy-Org/ComfyUI',   subcategory: 'AI image generation',       why: 'Stable Diffusion + Flux workflow editor. Generate IG-ready visuals in minutes.' },
  ...
  // ───────────────────────────────────────────────────────────────────
  {
    ...
    repos: [
      ...
      { full_name: 'Comfy-Org/ComfyUI',         subcategory: 'AI image gen',       why: 'Node-based Stable Diffusion. Industry standard for serious AI image work.' },
  ...
  // ───────────────────────────────────────────────────────────────────
  {
    ...
    repos: [
      ...
      { full_name: 'calcom/cal.diy',                    subcategory: 'Scheduling',       why: 'Calendly alternative. Embed booking on your site, never share a Calendly link again.' },
